...
class Test(JSONWrapper):
    ...
    def check_prereq_missing(self, include_valgrind_check=False):
        ...
        if include_valgrind_check and not Utility.verify_executable("valgrind",True):
            raise PrereqMissing("Missing valgrind tool -- install it ('sudo apt install valgrind' on Ubuntu Linux)")
